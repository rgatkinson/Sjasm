...
void pmLD(string line,Data &e) {
  ...
  case Z80mnn:
    ...
    if (!e.size()) break;
    check16(x.val); e.push((ubyte)x.val); e.push((ubyte)(x.val>>8));
    break;
  case Z80_A:
    switch (y.reg) {
    case Z80mBC: case Z80miBC: case Z80mdBC: case Z80mBCi: case Z80mBCd: 
    ...
    case Z80mnn: e.push(0x3a); check16(y.val); e.push((ubyte)y.val); e.push((ubyte)(y.val>>8)); break;
  ...
  case Z80_BC: case Z80_DE: case Z80_HL:
    ...
    if (!e.size()) break;
    check16(y.val); e.push((ubyte)y.val); e.push((ubyte)(y.val>>8));
    break;
  case Z80_I:
    if (y.reg!=Z80_A) break;
    e[0]=0xed; e[1]=0x47;
